...
import { Container, Title, Text, Button, Group, Card, Stack, SimpleGrid, ThemeIcon, List, Divider, Badge } from '@mantine/core';
import { IconArrowRight, IconAward, IconBookOpen, IconClipboard, IconExternalLink, IconFileText, IconPlusCircle, IconThumbsUp } from '@/components/icons/feather';
